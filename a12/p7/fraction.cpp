...
void Fraction::operator < (const Fraction& f) {
	if (num * f.den < den * f.num)
		cout << "The first fraction is smaller than the second." << endl;
	else if (num * f.den > den * f.num)
		cout << "The second fraction is smaller than the first." << endl;
}

//bigger than
void Fraction::operator > (const Fraction& f) {
	if (num * f.den > den * f.num)
		cout << "The first fraction is bigger than the second." << endl;
	else if (num * f.den < den * f.num)
		cout << "The second fraction is bigger than the first." << endl;
	else 
